...
def predict(test_data, ori_test_data):
    ...
    for batch_test_data in tqdm(test_dataloader, desc = "Predicting"):
        ...
        with torch.no_grad():
            if config["encoder"] == "BERT":
                batch_ent_shaking_outputs,                 batch_head_rel_shaking_outputs,                 batch_tail_rel_shaking_outputs = rel_extractor(batch_input_ids, 
        ...
        for ind in range(len(sample_list)):
            ...
            ent_shaking_tag,             head_rel_shaking_tag,             tail_rel_shaking_tag = batch_ent_shaking_tag[ind],                                     batch_head_rel_shaking_tag[ind],                                     batch_tail_rel_shaking_tag[ind]
